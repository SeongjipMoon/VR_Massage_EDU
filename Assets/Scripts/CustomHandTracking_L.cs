...
{
    public class CustomHandTracking_L : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (!isGrabbing)
            {
                CheckFingerPinch(OVRHand.HandFinger.Thumb, "thumb_touch_l");
                CheckFingerPinch(OVRHand.HandFinger.Index, "index_touch_l");
                CheckFingerPinch(OVRHand.HandFinger.Middle, "middle_touch_l");
                CheckFingerPinch(OVRHand.HandFinger.Ring, "ring_touch_l");
                CheckFingerPinch(OVRHand.HandFinger.Pinky, "pinky_touch_l");
            }
        }
