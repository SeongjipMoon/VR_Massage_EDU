...
public class TouchMe_R : MonoBehaviour
{
    //public Light light1;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            TriggerHapticFeedback("thumb_touch_r");
        }
        else if (other.transform == indexSphere)
        {
            TriggerHapticFeedback("index_touch_r");
        }
        else if (other.transform == middleSphere)
        {
            TriggerHapticFeedback("middle_touch_r");
        }
        else if (other.transform == ringSphere)
        {
            TriggerHapticFeedback("ring_touch_r");
        }
        else if (other.transform == pinkySphere)
        {
            TriggerHapticFeedback("pinky_touch_r");
        }
        else if (other.transform == wristSphere)
        {
            TriggerHapticFeedback("wrist_r");
        }
        /*
        // Light On/Off 토글
        if (light1 != null)
